...
function generateQuestion() {
  ...
  document.getElementById("question").innerHTML = `<math xmlns="http://www.w3.org/1998/Math/MathML"><mi>r</mi><mo>=</mo><mn>${radius}</mn><mo>,</mo><mi>&#x3b8;</mi><mo>=</mo><mn>${angle}</mn></math>`;
...
function checkAnswer() {
  ...
  const correctAnswer = (angle / 360) * Math.PI * Math.pow(radius, 2);
  currentQuestion++;
